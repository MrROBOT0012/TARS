export const ONBOARDING_STEPS = [
  ...
  },
  {
    ...
    cta: 'Ir a Proceso →',
    path: '/app/proceso?tab=secado&new=1',
    accent: '#C47B1A',
    target: 'Secado'
  },
  {
    ...
    cta: 'Ir a Proceso →',
    path: '/app/proceso?tab=embodegado&new=1',
    accent: '#7C3AED',
    target: 'Bodega'
  },
  {
    ...
    cta: 'Ir a Proceso →',
    path: '/app/proceso?tab=turnos&new=1',
    accent: '#0F766E',
    target: 'Trillo'
  },
  {
